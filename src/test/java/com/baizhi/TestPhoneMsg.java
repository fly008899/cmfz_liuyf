...
public class TestPhoneMsg {
    ...
    public static SendSmsResponse getMsg(String phoneNumbers,String signName,String templateCode,String templateParam ) throws Exception{
        ...
        //替换成你的AK
        final String accessKeyId = "LTAIrMjO0NMk26d7";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "5NAtMcdVSmFUbH4hyCPGvhdG2HBBLW";//你的accessKeySecret，参考本文档步骤2
    ...
    public static String getPhoneMsg(String phone){
        ...
        String redomCode = getSalt(6);
        //将验证码随机数存储起来,方便后期做校验

        String message=null;
        try {
            SendSmsResponse messages = getMsg(phone, "Duke", "SMS_172160009", "{\"code\":\""+redomCode+"\"}");
    ...
    public static void main(String[] args) {
        String message = getPhoneMsg("18538271080,13131597326");
